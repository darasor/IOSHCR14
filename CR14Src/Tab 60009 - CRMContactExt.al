table 60009 "IOSH_CRMContact"
{
    ...
    fields
    {
        ...
        field(50000; "BC Template Code"; Option)
        {
            Caption = 'BC Template Code';
            Description = 'Select the BC Template code.';
            ExternalName = 'iosh_bctemplatecode';
            ExternalType = 'Picklist';
            InitValue = UK;
