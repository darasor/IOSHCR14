            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field("Document No."; DocNo)
                    {
                        ApplicationArea = basic, suite;
                        Caption = 'Document No.';
                        ToolTip = 'Specified the Document No to which the report processes information.';
                    ...
                    field("External Document No."; ExtDocNo)
                    {
                        ...
                        ToolTip = 'Specified the External Document No to which the report processes information.';
