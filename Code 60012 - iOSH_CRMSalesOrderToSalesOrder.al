codeunit 60012 iOSH_CRMSalesOrderToSalesOrder
{
    ...
    begin
        ...
        //need to modify GetCRMAccount to ignore contact parent account type for iosh
        ...
        IF GetCRMAccountOfCRMSalesOrder(CRMSalesorder, CRMAccount) THEN begin
            ...
            if GetCRMContactOfCRMSalesOrder(CRMSalesorder, CRMContact) then begin
                ...
                CustMgt.createCustomerUseCRMContact(CRMContact.ContactId, Customer);
                exit(true);
            end else
    ...
    [Scope('Personalization')]
    procedure GetCRMAccount_Only_OfCRMSalesOrder(CRMSalesorder: Record 60007; var CRMAccount: Record 5341): Boolean;
    var
